...
class CruiserBikesPage extends StatefulWidget {
  const CruiserBikesPage({super.key});
  @override
  State<CruiserBikesPage> createState() => _CruiserBikesPageState();
}
class _CruiserBikesPageState extends State<CruiserBikesPage> {
  ...
  Widget build(BuildContext context) {
    MyDatabase.getProduct("cro").then(
          (value) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Cruiser Bikes'),
      ),
